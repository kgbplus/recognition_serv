...
import click
import logging
from recognition_serv.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("recognition_serv.app.utils.logging.click.style",
    ...
    @mock.patch("recognition_serv.app.utils.logging.logging.Formatter")
