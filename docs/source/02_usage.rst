...
2. Build local development docker image via::
    ...
    $ ./docker-compose.sh build recognition_serv

3. Run the API Service by::

    $ ./docker-compose.sh run --service-ports --rm recognition_serv
...
2. Build local development docker image via::
    ...
    $ ./docker-compose.sh build test_recognition_serv

3. Run the API Service by::

    $ ./docker-compose.sh run test_recognition_serv
